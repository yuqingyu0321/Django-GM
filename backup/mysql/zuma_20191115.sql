...
CREATE TABLE `oriented_bgendmodel` (
  ...
  `grid_iconsWidth` double NOT NULL,
  `grid_iconsHeight` double NOT NULL,
...
-- Dump completed on 2019-11-15 23:59:01
